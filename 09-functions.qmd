...
You can download a template Quarto file to start from [here](activity_templates/09-functions.qmd). Put this file in a folder called `functions` within a folder for this course.
