...
```{r ex_create_string_soln, error=TRUE}
...
```{r ex_create_string_slash_soln, error=TRUE}
x <- "C:\\Users"
str_view(x)
...
```{r ex_regex_start_end_group_soln}
