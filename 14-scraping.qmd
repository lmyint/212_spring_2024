...
You can download a template Quarto file to start from [here](activity_templates/14-scraping.qmd). Put this file in a folder called `data_acquisition` within a folder for this course.
