...
You can download a template Quarto file to start from [here](activity_templates/10-subset-str-shiny.qmd). Put this file in a folder called `functions` within a folder for this course.
...
Test your function on the `mtcars` dataset with your chosen
